package com.savvy.apartments.Network;
...
public class Iokihttp {
    ...
    public Call uploadImage(String id, File image, String imageName, String url, final Callback callback) throws IOException {
